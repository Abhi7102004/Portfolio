...
export default function Hero({ onIntroComplete }) {
  ...
  return (
    <section id="home" className="hero-section">
      ...
      <div className="hero-inner">
        ...
        {/* ── NAME: Abhishek ── no overflow:hidden clipping, use opacity+y instead */}
        <motion.h1
        ...
        >
          {BTNS.map((btn) => (
            <a
              ...
              target={
                getBtnHref(btn.label).startsWith("http") ? "_blank" : undefined
              }
              rel="noreferrer"
              style={{
                fontFamily: "'Syne',sans-serif",
              ...
              onMouseEnter={(e) => {
                ...
                if (!btn.solid && !btn.ghost) {
                  e.currentTarget.style.background = "#0E0E0D";
              ...
              onMouseLeave={(e) => {
                ...
                if (!btn.solid && !btn.ghost) {
                  ...
                  e.currentTarget.style.color = "#0E0E0D";
                }
        ...
        >
          {ME.stats.map((s, i) => (
            <motion.div
              ...
              initial={{ opacity: 0, y: 14 }}
              animate={introDone ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.4, delay: 0.84 + i * 0.09 }}
            >
              <div
                style={{
                  fontFamily: "'Syne',sans-serif",
  ...
  available = True
        ...
        >
          ...
          <motion.div
            style={{
              width: 1,
              height: 46,
              background: "linear-gradient(to bottom, #0E0E0D, transparent)",
              opacity: 0.2,
            }}
      ...
      <style>{`
        ...
        /* Mobile-first: padding-top = navbar height + small gap */
        .hero-inner {
          min-height: 100dvh;
          display: flex;
        ...
        /* ─────────────────────────────────────────
           NAME — mobile uses SYSTEM fonts only.
           No web font = no FOUT = no broken boxes.
        ───────────────────────────────────────── */
        .hero-name-first {
        ...
        /* ─────────────────────────────────────────
           CODE BLOCK — hidden on mobile/tablet
        ───────────────────────────────────────── */
        ...
        @media (max-width: 375px) {
          ...
          .hero-badge-text { font-size: 0.48rem; letter-spacing: 0.12em; }
        }

        /* Mid phones (376px – 480px) */
        ...
        @media (min-width: 481px) and (max-width: 767px) {
          .hero-inner { padding: 5.5rem 1.5rem 4rem; }
          .hero-badge-text { font-size: 0.58rem; }
        }

        /* Tablets (768px – 999px) — fix the huge blank space */
        ...
        /* Desktop (≥ 1000px) — switch to web fonts, show code block */
        @media (min-width: 1000px) {
          ...
          .code-block { display: block !important; }
        }

        /* Large desktop (≥ 1400px) */
        @media (min-width: 1400px) {
          .hero-inner { padding: 6rem 3rem 5rem; }
        }
      `}</style>
    </section>
  );
