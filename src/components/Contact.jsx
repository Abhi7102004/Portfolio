  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1550, margin: "0 auto" }}>
        ...
        >
          Open to internship and full-time opportunities in backend, fintech,
          and full-stack engineering. Let's build something production-grade
          together.
        </motion.p>
        ...
        >
          ...
          <a
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.borderColor = "#232321";
          ...
          {links.map((lnk, i) => (
            <a
              ...
              style={{
                ...
                textDecoration: "none",
                borderRight:
                  i < links.length - 1 ? "1px solid #232321" : "none",
                display: "flex",
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = "#0C0C0B")
              }
            >
              <div
                style={{
